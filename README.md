...
Setup creates, validates, and seals both `.operation.lock` and `.launch.lock`; read-only inspection requires both to remain regular non-reparse files with the declared authority.
