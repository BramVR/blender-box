...
- Start native Windows installer commands detached and retain exact Job-member handles during execution; require complete membership and physical exit proof within one cleanup deadline before reporting tree cleanup.
